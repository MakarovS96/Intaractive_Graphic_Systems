...
void CreateCubeTexture(GLuint cubeMap, Shader &shaderTerx, Model &trex, Shader &shaderCylinder, Model &cylinder, Shader &lightShader, Model &lightSphere);
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
        ...
        CreateCubeTexture(cube_tex, shaderTerx, trex, shaderCylinder, cylinder, lightShader, lightSphere);
...
void CreateCubeTexture(GLuint cubeMap, Shader &shaderTerx, Model &trex, Shader &shaderCylinder, Model &cylinder, Shader &lightShader, Model &lightSphere)
{
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        {
            case 0: {
                view = glm::lookAt(cubePos, cubePos + glm::vec3(1.0f, 0.0f, 0.0f) * glm::vec3(fk), glm::vec3(0.0f, -1.0f, 0.0f) * glm::vec3(uk));
                break;
            }
            ...
            case 2: {
                view = glm::lookAt(cubePos, cubePos + glm::vec3(0.0f, 1.0f, 0.0f) * glm::vec3(fk), glm::vec3(0.0f, 0.0f, 1.0f) * glm::vec3(uk));
                break;
            }
            ...
            case 4: {
                view = glm::lookAt(cubePos, cubePos + glm::vec3(0.0f, 0.0f, 1.0f) * glm::vec3(fk), glm::vec3(0.0f, -1.0f, 0.0f) * glm::vec3(uk));
                break;
            }
